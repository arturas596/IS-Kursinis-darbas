                ...
                <tr role="row" class="odd">
                  ...
                  <td>
                    <form class="row" method="POST" action="{{ route('user-management.destroy', $user->id) }}" onsubmit = "return confirm('Are you sure?')">
                        ...
                        <a href="{{ route('user-management.edit', $user->id) }}" title="Edit User" class="btn btn-info col-sm-3 col-xs-5 btn-margin">
                          <i class="fa fa-edit fa-lg"></i>
                        </a>
                        <a href="{{ route('user-management.edit', $user->id) }}" title="Print User" class="btn btn-primary col-sm-3 col-xs-5 btn-margin">
