                ...
                <tr role="row" class="odd">
                  ...
                  <td>
                    <form class="row" method="POST" action="{{ route('country.destroy', $country->id) }}" onsubmit = "return confirm('Are you sure?')">
                        ...
                        <a href="{{ route('country.edit', $country->id) }}" title="Edit Country" class="btn btn-info col-sm-3 col-xs-5 btn-margin">
                          <i class="fa fa-edit fa-lg"></i>
                        </a>
                        <a href="{{ route('country.edit', $country->id) }}" title="Print Country" class="btn btn-primary col-sm-3 col-xs-5 btn-margin">
