...
@section('action-content')
  ...
  <div class="box-header">
    <div class="row">
      <div class="col-sm-8">
        <h3 class="box-title" style="font-weight:bolder; text-transform:uppercase; font-family: 'Times New Roman', Times, serif">List of Districts</h3>
      </div>
        <div class="col-sm-4">
                ...
                <tr role="row" class="odd">
                  ...
                  <td>
                    <form class="row" method="POST" action="{{ route('state.destroy', $state->id) }}" onsubmit = "return confirm('Are you sure?')">
                        ...
                        <a href="{{ route('state.edit', $state->id) }}" class="btn btn-info col-sm-3 col-xs-5 btn-margin">
                          <i class="fa fa-edit fa-lg"></i>
                        </a>
                        <a href="{{ route('state.edit', $state->id) }}" title="Print State" class="btn btn-primary col-sm-3 col-xs-5 btn-margin">
